...
full_issue.drop_duplicates(subset=['tweet_content', 'Environment', 'Social Capital', 'Human Capital', 'Business Model & Innovation', 'Leadership & Governance', 'None'], keep="first", inplace=True)
...
y_issue = full_issue[['Environment', 'Social Capital', 'Human Capital', 'Business Model & Innovation', 'Leadership & Governance', 'None']]

print(y_issue.groupby(['Environment', 'Social Capital', 'Human Capital', 'Business Model & Innovation', 'Leadership & Governance', 'None']).size())
print(X_issue.head())
print(y_issue.head())
...
train_issue.to_pickle('E:/IR/data/NEW_train_wir_alik_fg_ext 251120.pkl')
train_issue.to_csv('E:/IR/data/NEW_train_wir_alik_fg_ext 251120.csv', index=False, sep=';', encoding='utf-8-sig')
test_issue.to_csv('E:/IR/data/NEW_test_wir_alik_fg_ext 251120.csv', index=False, sep=';', encoding='utf-8-sig')
test_issue.to_pickle('E:/IR/data/NEW_test_wir_alik_fg_ext 251120.pkl')
